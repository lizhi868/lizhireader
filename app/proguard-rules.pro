...
# and specify the fully qualified class name to the JavaScript interface_setting
# class:
#-keepclassmembers class fqcn.of.javascript.interface_setting.for.webview {
#   public *;
#}
#
# 对于一些基本指令的添加
...
-keep class com.lizhi.reader.widget.**{*;}
-keep class com.lizhi.reader.bean.**{*;}
...
-keep public class com.lizhi.reader.R$*{
