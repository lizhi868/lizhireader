...
public final class TintHelper {
    ...
    public static void setTint(@NonNull SeekBar seekBar, boolean useDarker) {
        if (seekBar.isEnabled()){
            if (useDarker){
                Drawable progressDrawable = ContextCompat.getDrawable(seekBar.getContext(),R.drawable.seekbar_bg);
                seekBar.setProgressDrawable(progressDrawable);
                Drawable thumbDrawable = ContextCompat.getDrawable(seekBar.getContext(),R.drawable.seekbar_thumb);
            ...
            if (useDarker){
                Drawable progressDrawable = ContextCompat.getDrawable(seekBar.getContext(),R.drawable.seekbar_disable_bg);
                seekBar.setProgressDrawable(progressDrawable);
                Drawable thumbDrawable = ContextCompat.getDrawable(seekBar.getContext(),R.drawable.seekbar_disable_thumb);
                seekBar.setThumb(thumbDrawable);
            }else {
                Drawable progressDrawable = ContextCompat.getDrawable(seekBar.getContext(),R.drawable.seekbar_disable_bg);
                seekBar.setProgressDrawable(progressDrawable);
