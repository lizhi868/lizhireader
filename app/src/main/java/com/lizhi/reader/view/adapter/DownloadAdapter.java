...
import com.lizhi.reader.view.activity.DownloadActivity;
...
public class DownloadAdapter extends RecyclerView.Adapter<DownloadAdapter.MyViewHolder> {
    ...
    private DataNumberListener listener;

    public interface DataNumberListener {
    ...
    public void setListener(DataNumberListener listener) {
    ...
    public void upDataS(List<DownloadBookBean> dataS) {
        ...
        if (listener != null) {
            listener.dataNumber(data == null ? 0 : data.size());
        }
        if (dataS != null) {
    ...
    public void upData(DownloadBookBean data) {
        ...
        if (listener != null) {
            listener.dataNumber(this.data == null ? 0 : this.data.size());
        }
        if (index >= 0) {
