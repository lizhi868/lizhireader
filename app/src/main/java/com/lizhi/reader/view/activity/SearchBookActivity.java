...
import com.lizhi.reader.presenter.SearchBookPresenter;
import com.lizhi.reader.presenter.contract.SearchBookContract;
...
import com.lizhi.reader.view.adapter.SearchBookshelfAdapter;
import com.lizhi.reader.widget.explosion_field.ExplosionField;
...
public class SearchBookActivity extends MBaseActivity<SearchBookContract.Presenter>
    ...
    @BindView(R.id.iv_search_history_clean)
    ImageView ivSearchHistoryClean;
...
//    }
    ...
    private void initSearchView() {
        ...
        mSearchAutoComplete.setTextColor(ContextCompat.getColor(this, R.color.color_202E3D));
        mSearchAutoComplete.setHintTextColor(ContextCompat.getColor(this, R.color.color_C5CDD6));
        mSearchAutoComplete.setPadding(Utils.dp2Px(20), 0, 0, 0);
        searchView.onActionViewExpanded();
        searchView.setPadding(0, 0, Utils.dp2Px(16), 0);
...
//        closeButton.setScaleY(0.9f);
    ...
    protected void bindEvent() {
        ivSearchHistoryClean.setOnClickListener(v -> {
    ...
    public void querySearchHistorySuccess(List<SearchHistoryBean> data) {
        ...
        if (flSearchHistory.getChildCount() > 0) {
            ivSearchHistoryClean.setVisibility(View.VISIBLE);
        } else {
            ivSearchHistoryClean.setVisibility(View.INVISIBLE);
        }
    }
