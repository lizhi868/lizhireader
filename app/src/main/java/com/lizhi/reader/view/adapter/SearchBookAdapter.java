...
import com.lizhi.reader.bean.BookKindBean;
...
import static com.lizhi.reader.utils.StringUtils.isTrimEmpty;
...
public class SearchBookAdapter extends RefreshRecyclerViewAdapter {
    ...
    public void onBindIViewHolder(final RecyclerView.ViewHolder holder, final int position) {
        ...
        if (isTrimEmpty(bookKindBean.getKind())) {
            myViewHolder.tvKind.setVisibility(View.INVISIBLE);
        } else {
...
//        }
        ...
        if (isTrimEmpty(searchBooks.get(position).getLastChapter())) {
            myViewHolder.tvLasted.setVisibility(View.INVISIBLE);
        } else {
...
//            myViewHolder.tvIntroduce.setVisibility(View.INVISIBLE);
//        } else {
