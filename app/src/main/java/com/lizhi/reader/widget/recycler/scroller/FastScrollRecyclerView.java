package com.lizhi.reader.widget.recycler.scroller;
...
public class FastScrollRecyclerView extends RecyclerView {
     ...
     *
     * @param fastScrollStateChangeListener The interface_setting that will listen to fastscroll state change events
     */
