package com.lizhi.reader.widget.modialog;
...
import com.lizhi.reader.view.adapter.ChangeSourceAdapter;
...
//        rvSource.addItemDecoration(new DividerItemDecoration(context, LinearLayout.VERTICAL));
        ...
        editText.setHintTextColor(ContextCompat.getColor(context, R.color.color_C5CDD6));
        editText.setTextColor(ContextCompat.getColor(context, R.color.color_202E3D));
...
//        getWindow().setAttributes(params);
        ...
        layoutParams.height = ScreenUtils.getAppSize()[1] - Utils.dp2Px(66);
