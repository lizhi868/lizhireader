...
import static com.lizhi.reader.widget.page.PageLoader.DEFAULT_MARGIN_WIDTH;
...
public class ReadBookControl {
    ...
    void updateReaderSettings() {
        ...
        this.tipPaddingTop = preferences.getInt("tipPaddingTop", ScreenUtils.dpToPx(22));
        this.tipPaddingRight = preferences.getInt("tipPaddingRight", DEFAULT_MARGIN_WIDTH);
        this.tipPaddingBottom = preferences.getInt("tipPaddingBottom", ScreenUtils.dpToPx(10));
