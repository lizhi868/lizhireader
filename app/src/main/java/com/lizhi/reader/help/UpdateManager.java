...
import com.lizhi.reader.bean.UpdateInfoBean;
import com.lizhi.reader.model.analyzeRule.AnalyzeHeaders;
...
public class UpdateManager {
    ...
    public void checkUpdate(boolean showMsg) {
        BaseModelImpl.getInstance().getRetrofitString("https://api.github.com")
                ...
                .get(MApplication.getInstance().getString(R.string.app_name), AnalyzeHeaders.getMap(null))
